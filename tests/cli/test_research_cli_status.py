"""`astercaeser-research list --status complete` must match completed runs.
...
def _load_cli():
    ...
    loader = importlib.machinery.SourceFileLoader("astercaeser_research_cli_status", str(path))
