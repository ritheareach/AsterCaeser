...
COPILOT_USER_AGENT = os.environ.get(
    "ASTERCAESER_COPILOT_USER_AGENT", "AsterCaeser/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "ASTERCAESER_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "ASTERCAESER_COPILOT_EDITOR_VERSION", "AsterCaeser/1.0"
)
