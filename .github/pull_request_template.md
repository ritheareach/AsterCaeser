...
- [ ] I searched [open issues](https://github.com/astercaeser-dev/astercaeser/issues) and [open PRs](https://github.com/astercaeser-dev/astercaeser/pulls) — this is not a duplicate.
- [ ] This PR targets `dev`
...
- [ ] **Style match**: the change uses AsterCaeser's existing visual language. Specifically:
