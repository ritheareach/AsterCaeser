"""`astercaeser-research list --status complete` was returning nothing.
...
Part of #2122 (astercaeser-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "astercaeser-research"
    loader = importlib.machinery.SourceFileLoader("astercaeser_research_cli", str(path))
