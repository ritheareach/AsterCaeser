...
class MemoryProvider(ABC):
    """Base contract for AsterCaeser memory providers.
...
class NativeMemoryProvider(MemoryProvider):
    """Provider adapter for AsterCaeser' built-in memory manager and vector store."""

    provider_id = "native"
    display_name = "AsterCaeser native memory"
