"""cmd_add (scripts/astercaeser-memory) must tolerate a non-dict row in the
...
def _load_cli(monkeypatch):
    ...
    path = ROOT / "scripts" / "astercaeser-memory"
    loader = importlib.machinery.SourceFileLoader("astercaeser_memory_cli_add", str(path))
