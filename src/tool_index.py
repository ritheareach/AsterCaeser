...
COLLECTION_NAME = "astercaeser_tool_index"
...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "spawn_subagent": "Delegate a task to a fresh-context subagent that works autonomously with its own tools and returns a final answer. Use for deep research, large file analysis, or multi-step work.",
