...
```text
[order-report] working directory: /path/to/astercaeser
...
[order-report] reproduce with: /path/to/astercaeser/venv/bin/python /path/to/astercaeser/tests/run_order_report.py --seed 284734921 -- tests/cli/ -q
```
