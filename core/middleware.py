...
INTERNAL_TOOL_TOKEN = os.environ.get("ASTERCAESER_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-AsterCaeser-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-AsterCaeser-Internal-Token), or
