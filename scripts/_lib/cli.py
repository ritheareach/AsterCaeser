"""scripts/_lib/cli.py — shared scaffolding for the `astercaeser-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("astercaeser-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/astercaeser-foo`
...
VERSION = "0.1.0"  # bumped centrally; every astercaeser-* CLI reports this
