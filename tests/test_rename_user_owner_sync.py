...
def _request(
    ...
    return SimpleNamespace(
        cookies={"astercaeser_session": token},
...
def test_rename_research_respects_custom_data_dir(monkeypatch, tmp_path):
    """DEEP_RESEARCH_DIR (which honours ASTERCAESER_DATA_DIR) is used, not a
    hardcoded relative path. Before the fix, setting ASTERCAESER_DATA_DIR made
