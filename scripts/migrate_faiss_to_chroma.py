...
Migrates:
  - Memory vectors: data/memory_vectors/ -> astercaeser_memories collection
  - RAG vectors:    data/rag/            -> astercaeser_rag collection
